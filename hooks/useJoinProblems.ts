...
export function useJoinProblems() {
  ...
  if (joinProblem.length === 0) {
    console.log("problemMap", problemMap, problemPending, problemError);
    console.log("contestMap", contestMap, contestPending, contestError);
    console.log("tagMap", tagMap, tagPending, tagError);
    console.log("solutionMap", solutionMap, solutionPending, solutionError);
  }
